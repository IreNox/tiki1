    ...
    public partial class ucProperties : UserControl
    {
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            if (dialogOpenFile.ShowDialog(this) != DialogResult.Cancel)
            {
                ...
                {
                    string fileName = dialogOpenFile.FileName.Substring(0, dialogOpenFile.FileName.Length - Path.GetExtension(dialogOpenFile.FileName).Length);
        ...
        public object CurrentObject
        {
            ...
            set
            {
                if (SettingsChanged && _currentObject != null && _currentObject != value)
                {
                    Save();
                }
        ...
        public class ComboBoxItem
        {
            ...
            private NameObject _object;
            #endregion

            #region Init
            public ComboBoxItem(NameObject obj)
                : this(obj, "Name")
            {
            }

            public ComboBoxItem(NameObject obj, string textMember)
            {
                _object = obj;
            ...
            public string Id
            {
                get
                {
                    return _object == null ? "" : _object.Name;
                }
            }
